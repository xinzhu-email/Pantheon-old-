...
class FlowPlot:
    def __init__(self, data, color_map, x_init_idx = 0, y_init_idx = 0, allow_select = True, select_color_change = True, legend = None, main_plot = None):
        ...
        print('label and vie existed',self.label_existed,view_existed)
        ...
        self.log_axis.on_click(self.log_cb)
    ...
    def base_tool(self):
        ...
        layout=row(column(Figure.p, Figure.show_gene_list, Figure.para_color, Figure.trigger_color),
            ...
            column(Figure.show_selected_class, Figure.add_to, Figure.remove_from, Figure.update_class, 
             Figure.rename_class, Figure.change_class_color, Figure.merge_class, Figure.delete_class))
